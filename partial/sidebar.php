<?php ?>
<div class="sidebar min-h-screen w-56 overflow-hidden border-r bg-white">
  <div class="flex h-screen flex-col justify-between pt-2 pb-6">
    <div>
      <div class="flex justify-center w-full p-2.5">
        <img src="./static/image/logo.png" class="w-32" alt="">
      </div>
      <div class="w-full h-6 hover:h-12 overflow-hidden text-center">
        <span class="text-gray-700"><?= 'Hi, '.$_SESSION['user_name'] ?></span><br>
        <a href="./login.php?logout"><span class="text-gray-700">登出</span></a>
      </div>
      <ul class="mt-6 space-y-2 tracking-wide">
        <li class="min-w-max">
          <a href="./index.php" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="18px">
                <path class="fill-current text-gray-600 group-hover:text-cyan-600" fill="#dff0fe"
                d="M3.5 38.5L3.5 13.286 19.998 3.58 36.5 13.286 36.5 38.5z" />
                <path class="fill-current text-gray-300 group-hover:text-cyan-300" fill="#4788c7"
                d="M19.998,4.16L36,13.572V38H4V13.572L19.998,4.16 M19.998,3L3,13v26h34V13L19.998,3L19.998,3z" />
                <path class="fill-current text-gray-300 group-hover:text-cyan-300" fill="#b6dcfe"
                ...
                <g>
                <path class="fill-current text-gray-300 group-hover:text-cyan-300" fill="#b6dcfe"
                    d="M14.5 21.5H25.5V38.5H14.5z" />
                <path class="fill-current text-gray-300 group-hover:text-cyan-300" fill="#4788c7"
                    d="M25,22v16H15V22H25 M26,21H14v18h12V21L26,21z" />
                </g>
            </svg>
            <span class="group-hover:text-gray-700">回首頁</span>
          </a>
        </li>
      <li class="min-w-max">
        <a href="./house-manage.php" aria-label="dashboard"
        class="relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
          ...
          <span class="-mr-1 font-medium">房屋管理</span>
        </a>
      </li>
      <!-- <li class="min-w-max">
