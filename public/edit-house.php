      ...
      <form action="./edit-house.php<?= '?id='.$_GET['id'] ?>" method="post" enctype="multipart/form-data">
        <div>
          ...
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="title"
            id="title" value="<?= isset($_POST['title']) ? $_POST['title'] : $house['title'] ?>"/>
        </div>
        <div>
          ...
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="subtitle"
            id="subtitle" value="<?= isset($_POST['subtitle']) ? $_POST['subtitle'] : $house['subtitle'] ?>"/>
        </div>
        <div>
          ...
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="region"
            id="region" value="<?= isset($_POST['region']) ? $_POST['region'] : $house['region'] ?>"/>
        </div>
        <div>
          <label class="text-gray-800 font-semibold block my-3 text-md" for="rent">租金</label>
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="rent" id="rent" value="<?= isset($_POST['rent']) ? $_POST['rent'] : $house['rent'] ?>"/>
        </div>
        <div>
          <label class="text-gray-800 font-semibold block my-3 text-md" for="vr_url">VR 看房網址</label>
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="vr_url" id="vr_url" value="<?= isset($_POST['vr_url']) ? $_POST['vr_url'] : $house['vr_url'] ?>"/>
        </div>
        <div>
          ...
          <textarea class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text" name="description"
            id="description"><?= isset($_POST['description']) ? $_POST['description'] : $house['description'] ?></textarea>
        </div>
        <div>
          ...
          <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" type="text" name="house_img"
            id="house_img" value="<?= isset($_POST['images'][0]) ? $_POST['images'][0] : $house['images'][0] ?>" disabled />
        </div>
        <div>
